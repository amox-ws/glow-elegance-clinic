      ...
      <section className="py-20 bg-background">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center max-w-6xl mx-auto">
            <div data-anim="left">
              <img src={meetthedoctor} alt="Doctor Portrait" className="rounded-2xl shadow-elegant w-full h-auto" />
            </div>
            ...
            <div data-anim="right" className="hidden lg:block">
              <div className="relative">
                <div className="aspect-[3/4] rounded-2xl overflow-hidden shadow-elegant bg-muted">
                  <img src={whychooseus} alt="Aesthetic treatments" className="w-full h-full object-cover" loading="lazy" />
                </div>
              </div>
            </div>
          </div>
